        ...
        <li>
            ...
            <ul>
                <li>
                    ...
                    <ul>
                        <li><a class="scrolly" target="_blank" href="<?php echo WHATSAPP_URL; ?>">Amarres de amor</a></li>
                        ...
                        <li><a class="scrolly" target="_blank" href="<?php echo WHATSAPP_URL; ?>">Unión familiar</a></li>
                        <li><a class="scrolly" target="_blank" href="<?php echo WHATSAPP_URL; ?>">Protección contra envidias</a></li>
                        <li><a class="scrolly" target="_blank" href="<?php echo WHATSAPP_URL; ?>">Éxito en negocios</a></li>
                        <li><a class="scrolly" target="_blank" href="<?php echo WHATSAPP_URL; ?>">Rituales de prosperidad</a></li>
                        <li><a class="scrolly" target="_blank" href="<?php echo WHATSAPP_URL; ?>">Rituales para la suerte</a></li>
                    </ul>
                </li>
            </ul>
        </li>
