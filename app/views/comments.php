<section id="comments" class="col-4 col-12-mobile">
	<header>
		<h2 class="icon solid fa-comment circled"><span class="label">Comentarios</span></h2>
	</header>
	<ul class="divided">
		<li>
			<article class="tweet">
		...
		<li>
			<article class="tweet">
				...
				<span class="timestamp">hace 5 días</span>
			</article>
		</li>
		<li>
			<article class="tweet">
